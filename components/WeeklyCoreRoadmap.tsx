...
export function WeeklyCoreRoadmap() {
  return (
    <section className="rounded-3xl border border-zinc-200 bg-zinc-50 p-5 dark:border-zinc-800 dark:bg-zinc-900/40">
      <h2 className="text-base font-semibold text-zinc-900 dark:text-zinc-100">
        📊 Weekly core & abs roadmap
      </h2>
      <div className="mt-4 overflow-x-auto rounded-2xl border border-zinc-200 dark:border-zinc-800/80">
        <table className="w-full min-w-[320px] text-left text-sm">
          <thead>
            <tr className="border-b border-zinc-200 bg-zinc-100 text-xs uppercase tracking-wide text-zinc-600 dark:border-zinc-800 dark:bg-zinc-950/80 dark:text-zinc-500">
          ...
          <tbody className="text-zinc-700 dark:text-zinc-300">
            <tr className="border-b border-zinc-200/80 dark:border-zinc-800/60">
      ...
      <ul className="mt-4 space-y-2 text-xs leading-relaxed text-zinc-600 dark:text-zinc-400">
        <li>
          ...
          habit, posture, waist feels tighter.
        </li>
        <li>
          <span className="font-semibold text-zinc-800 dark:text-zinc-300">
            M3–M4:
          </span>{" "}
          waist down, upper abs in good lighting if deficit holds.
        </li>
        <li>
          <span className="font-semibold text-zinc-800 dark:text-zinc-300">
            M5–M6:
          </span>{" "}
          clearer definition flexed → visible in natural light with consistency.
        </li>
      </ul>
      <p className="mt-4 rounded-2xl border border-amber-200 bg-amber-50 px-3 py-2 text-xs text-amber-900 dark:border-amber-500/20 dark:bg-amber-950/30 dark:text-amber-100/90">
